  ...
  constructor() {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <template id="dir-item">
        <li class="item ${tw`flex items-center w-full`}">
      ...
      <template id="file-item">
        <li class="item ${tw`flex items-center w-full hover:bg-gray-100`}">
          <div class="head">
    ...
    for (let i = 0; i < this.src.length; i += 1) {
      ...
      if (pos.type === fileType.DIR) {
        ...
        item.addEventListener('click', () => {
          ...
          this.fileList.querySelectorAll('.item')
